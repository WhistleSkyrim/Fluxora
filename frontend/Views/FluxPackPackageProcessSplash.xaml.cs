...
public partial class FluxPackPackageProcessSplash : System.Windows.Controls.UserControl
{
    ...
    public static readonly DependencyProperty CloseCommandProperty = DependencyProperty.Register(
        nameof(CloseCommand),
        typeof(ICommand),
        typeof(FluxPackPackageProcessSplash),
    ...
    public FluxPackPackageProcessSplash()
    {
        InitializeComponent();
    ...
    private void OnSourcePropertyChanged(object? sender, PropertyChangedEventArgs e)
    {
        ...
        {
            case nameof(FluxPackPackageProcessViewModel.CurrentStep):
                Dispatcher.Invoke(() => AnimateStepChange(GetStepFromDataContext()));
                break;
            case nameof(FluxPackPackageProcessViewModel.IsVisible):
            case nameof(FluxPackPackageProcessViewModel.IsCompleted):
            case nameof(FluxPackPackageProcessViewModel.HasError):
    ...
    {
        return DataContext is FluxPackPackageProcessViewModel viewModel
    ...
    {
        if (DataContext is not FluxPackPackageProcessViewModel viewModel || !viewModel.IsVisible)
        {
            isFinalState = false;
    ...
    private void SyncStateGlyph(FluxPackPackageProcessViewModel viewModel)
    {
        StateGlyph.Text = viewModel.HasError ? "\uE7BA" : "\uE73E";
        StateGlyph.Foreground = (System.Windows.Media.Brush)FindResource(
            viewModel.HasError ? "PackageErrorBrush" : "PackageSuccessBrush");
    }
}
